...
func (api *API) GetTrendingTagsRaw(afterTag string, limit uint32) (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_trending_tags", []interface{}{afterTag, limit})
}
...
func (api *API) GetBlockHeaderRaw(blockNum uint32) (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_block_header", []uint32{blockNum})
}

func (api *API) GetBlockRaw(blockNum uint32) (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_block", []uint32{blockNum})
}

func (api *API) GetBlock(blockNum uint32) (*Block, error) {
	var resp Block
	if err := api.caller.Call(APIID+".get_block", []uint32{blockNum}, &resp); err != nil {
		return nil, err
	}
...
func (api *API) GetStateRaw(path string) (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_state", []string{path})
}

func (api *API) GetTrendingCategoriesRaw(after string, limit uint32) (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_trending_categories", []interface{}{after, limit})
}

func (api *API) GetBestCategoriesRaw(after string, limit uint32) (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_best_categories", []interface{}{after, limit})
}

func (api *API) GetActiveCategoriesRaw(after string, limit uint32) (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_active_categories", []interface{}{after, limit})
}

func (api *API) GetRecentCategoriesRaw(after string, limit uint32) (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_recent_categories", []interface{}{after, limit})
}
...
func (api *API) GetConfigRaw() (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_config", call.EmptyParams)
}

func (api *API) GetConfig() (*Config, error) {
	var resp Config
	if err := api.caller.Call(APIID+".get_config", call.EmptyParams, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (api *API) GetDynamicGlobalPropertiesRaw() (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_dynamic_global_properties", call.EmptyParams)
}

func (api *API) GetDynamicGlobalProperties() (*DynamicGlobalProperties, error) {
	var resp DynamicGlobalProperties
	if err := api.caller.Call(APIID+".get_dynamic_global_properties", call.EmptyParams, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (api *API) GetChainPropertiesRaw() (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_chain_properties", call.EmptyParams)
}

func (api *API) GetFeedHistoryRaw() (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_feed_history", call.EmptyParams)
}

func (api *API) GetCurrentMedianHistoryPriceRaw() (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_current_median_history_price", call.EmptyParams)
}

func (api *API) GetWitnessScheduleRaw() (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_witness_schedule", call.EmptyParams)
}

func (api *API) GetHardforkVersionRaw() (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_hardfork_version", call.EmptyParams)
}

func (api *API) GetHardforkVersion() (string, error) {
	var resp string
	if err := api.caller.Call(APIID+".get_hardfork_version", call.EmptyParams, &resp); err != nil {
		return "", err
	}
	return resp, nil
}
...
func (api *API) GetNextScheduledHardforkRaw() (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_next_scheduled_hardfork", call.EmptyParams)
}
...
//	return call.Raw(api.caller, APIID + ".get_key_references", [][]string{key})
//}
...
func (api *API) GetAccountsRaw(accountNames []string) (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_accounts", [][]string{accountNames})
}

// XXX: Not sure about params.
//func (api *API) GetAccountReferenceRaw(id string) (*json.RawMessage, error) {
//	return call.Raw(api.caller, APIID + ".get_account_reference", []string{id})
//}

func (api *API) LookupAccountNamesRaw(accountNames []string) (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".lookup_account_names", [][]string{accountNames})
}

func (api *API) LookupAccountsRaw(lowerBoundName string, limit uint32) (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".lookup_accounts", []interface{}{lowerBoundName, limit})
}

func (api *API) GetAccountCountRaw() (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_account_count", call.EmptyParams)
}

func (api *API) GetConversionRequestsRaw(accountName string) (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_conversion_requests", []string{accountName})
}

func (api *API) GetAccountHistoryRaw(account string, from uint64, limit uint32) (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_account_history", []interface{}{account, from, limit})
}
...
func (api *API) GetOrderBookRaw(limit uint32) (*json.RawMessage, error) {
	...
	return call.Raw(api.caller, APIID+".get_order_book", []interface{}{limit})
}
...
func (api *API) GetActiveVotesRaw(author, permlink string) (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_active_votes", []string{author, permlink})
}

func (api *API) GetActiveVotes(author, permlink string) ([]*VoteState, error) {
	var resp []*VoteState
	if err := api.caller.Call(APIID+".get_active_votes", []string{author, permlink}, &resp); err != nil {
		return nil, err
	}
	return resp, nil
}
...
func (api *API) GetAccountVotesRaw(voter string) (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_account_votes", []string{voter})
}
...
func (api *API) GetContentRaw(author, permlink string) (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_content", []string{author, permlink})
}
...
func (api *API) GetContentRepliesRaw(parentAuthor, parentPermlink string) (*json.RawMessage, error) {
	return call.Raw(api.caller, APIID+".get_content_replies", []string{parentAuthor, parentPermlink})
}

func (api *API) GetContentReplies(parentAuthor, parentPermlink string) ([]*Content, error) {
	var resp []*Content
	err := api.caller.Call(APIID+".get_content_replies", []string{parentAuthor, parentPermlink}, &resp)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (api *API) GetRepliesByLastUpdateRaw(
	...
	return call.Raw(
		api.caller, APIID+".get_replies_by_last_update", []interface{}{startAuthor, startPermlink, limit})
}
...
func (api *API) GetOpsInBlockRaw(blockNum uint32, onlyVirtual bool) (*json.RawMessage, error) {
	return call.Raw(
		api.caller, APIID+".get_ops_in_block", []interface{}{blockNum, onlyVirtual})
}

func (api *API) GetOpsInBlock(blockNum uint32, onlyVirtual bool) ([]*types.OperationObject, error) {
	var resp []*types.OperationObject
	err := api.caller.Call(APIID+".get_ops_in_block", []interface{}{blockNum, onlyVirtual}, &resp)
	if err != nil {
		return nil, err
	}
	return resp, nil
